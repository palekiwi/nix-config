...
//,--------------------------------------------------------.                      ,--------------------------------------------------------.
   KC_NO,   KC_Q,     KC_W,     HM_F,     HM_P,     KC_B,                            KC_J,     HM_L,     HM_U,     KC_Y,    KC_PAUS, KC_NO,
//|------+---------+---------+---------+---------+---------|                      |---------+---------+---------+---------+---------+------|
...
[PCT] = LAYOUT_split_3x6_3(
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
     KC_NO,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, TG(HSH), KC_NO,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
[MED] = LAYOUT_split_3x6_3(
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_F19,  KC_PSCR, KC_F12,    KC_F20, KC_MPLY, KC_MUTE
                                      //`--------------------------'  `--------------------------'
),
