...
local base = {
  ...
  { "<space>en",       function() cue_utils.pick_artifacts({ type = "note", branch = vim.g.git_master }) end, desc = "Notes (" .. (vim.g.git_master or "master") .. ")" },
  ...
  { "<space>no",       function() cue_utils.add_with_title("todo", vim.g.git_master) end,                     desc = "Todo (" .. (vim.g.git_master or "master") .. ")" },
  { "<space>nO",       function() cue_utils.add_with_title("todo") end,                                       desc = "Todo (current)" },
  { "<space>nn",       function() cue_utils.add_with_title("note", vim.g.git_master) end,                     desc = "Note (" .. (vim.g.git_master or "master") .. ")" },
  { "<space>nN",       function() cue_utils.add_with_title("note") end,                                       desc = "Note (current)" },
