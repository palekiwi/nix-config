...
local cue_utils = require('config.utils.cue')
...
local base = {
  ...
  { "<space>et",       function() cue_utils.pick_artifacts({ type = "todo" }) end,                            desc = "Todos (current)" },
  ...
  { "<space>eat",      function() cue_utils.pick_artifacts({ type = "todo", all = true }) end,                desc = "Todos" },
  ...
  { "<space>n",        group = "new" },
  { "<space>nt",       function() cue_utils.add_with_title("todo") end,                                       desc = "Todo (current)" },
