...
local base = {
  ...
  -- AI / Cue
  { "<C-t>",           function() cue_utils.pick_artifacts({ type = "task", task = "master", board = true }) end, desc = "[Cue] Task board (no done/inbox)" },
  ...
  { "<space>ei",       cue_utils.pick_inbox_tasks,                                                desc = "Inbox tasks (status inbox)" },
  { "<space>ec",       cue_utils.pick_done_tasks,                                                desc = "Done tasks (complete/closed)" },
  { "<space>eo",       function() cue_utils.pick_artifacts({ type = "todo", task = "master" }) end, desc = "Todos (master)" },
  { "<space>eO",       function() cue_utils.pick_artifacts({ type = "todo" }) end,                  desc = "Todos (current task)" },
  { "<space>es",       function() cue_utils.pick_artifacts({ type = "spec", task = "master" }) end, desc = "Specs (master)" },
  { "<space>eS",       function() cue_utils.pick_artifacts({ type = "spec" }) end,                  desc = "Specs (current task)" },
  { "<space>ed",       function() cue_utils.pick_artifacts({ type = "doc", task = "master" }) end,  desc = "Docs (master)" },
  { "<space>eD",       function() cue_utils.pick_artifacts({ type = "doc" }) end,                   desc = "Docs (current task)" },
  { "<space>ep",       function() cue_utils.pick_artifacts({ type = "plan", task = "master" }) end, desc = "Plans (master)" },
  { "<space>eP",       function() cue_utils.pick_artifacts({ type = "plan" }) end,                  desc = "Plans (current task)" },
  { "<space>en",       function() cue_utils.pick_artifacts({ type = "note", task = "master" }) end, desc = "Notes (master)" },
  ...
  { "<space>ean",      function() cue_utils.pick_artifacts({ type = "note", all = true }) end,      desc = "Notes" },
  { "<space>eaa",      function() cue_utils.pick_artifacts({ all = true }) end,                     desc = "All artifacts" },
  { "<space>eb",       cue_utils.pick_task_context_artifacts,                                       desc = "Select task context" },
  { "<space>eu",       cue_utils.ui_pick,                                                           desc = "UI (Pick)" },
  { "<space>n",        group = "new" },
  { "<space>nt",       cue_utils.add_task,                                                          desc = "Task" },
  { "<space>no",       function() cue_utils.add_with_slug("todo") end,                            desc = "Todo" },
  { "<space>nn",       function() cue_utils.add_with_slug("note") end,                            desc = "Note" },
  ...
  { "<A-l>",           cue_utils.open_log,                                                          desc = "Open log" },
