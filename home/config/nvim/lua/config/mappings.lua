...
local base = {
  ...
  { "<A-t>",           function() mem_utils.pick_artifacts({ branch = vim.g.git_base }) end,                  desc = "[Mem] Base branch artifacts" },
  { "<space>e",        group = "entries" },
  { "<space>et",       function() mem_utils.pick_artifacts({ type = "todo" }) end,                            desc = "Todos (current)" },
  { "<space>eT",       function() mem_utils.pick_artifacts({ type = "todo", branch = vim.g.git_master }) end, desc = "Todos (master)" },
  { "<space>es",       function() mem_utils.pick_artifacts({ type = "spec" }) end,                            desc = "Specs (current)" },
  { "<space>eS",       function() mem_utils.pick_artifacts({ type = "spec", branch = vim.g.git_master }) end, desc = "Specs (master)" },
  { "<space>ed",       function() mem_utils.pick_artifacts({ type = "doc" }) end,                             desc = "Docs (current)" },
  { "<space>eD",       function() mem_utils.pick_artifacts({ type = "doc", branch = vim.g.git_master }) end,  desc = "Docs (master)" },
  { "<space>ep",       function() mem_utils.pick_artifacts({ type = "plan" }) end,                            desc = "Plans (current)" },
  { "<space>eP",       function() mem_utils.pick_artifacts({ type = "plan", branch = vim.g.git_master }) end, desc = "Plans (master)" },
  ...
  { "<space>nP",       function() mem_utils.add_with_title("plan", vim.g.git_master) end,                     desc = "Plan (master)" },
  ...
  { "<space>nD",       function() mem_utils.add_with_title("doc", vim.g.git_master) end,                      desc = "Doc (master)" },
