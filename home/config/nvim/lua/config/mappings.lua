...
local base = {
  ...
  { "tm",              function() git_utils.set_base_branch(vim.g.git_master) end,             desc = "Change base: master" },
  ...
  { "<leader>gyb",     function() gh_utils.copy_file_url({ branch = vim.g.git_base }) end,     desc = "GH file: base" },
  { "<leader>gyc",     gh_utils.copy_files_changed_url,                                        desc = "GH files changed" },
  { "<leader>gyd",     gh_utils.copy_diff_url,                                                 desc = "GH diff" },
  { "<leader>gyf",     gh_utils.copy_file_url,                                                 desc = "GH file: current" },
  { "<leader>gyh",     gh_utils.copy_blame_hash_short,                                         desc = "GH file: short hash" },
  { "<leader>gym",     function() gh_utils.copy_file_url({ branch = "master" }) end,           desc = "GH file: master" },
  { "<leader>gyp",     function() gh_utils.copy_file_url({ branch = vim.fn.getreg("+") }) end, desc = "GH file: clipboard" },
  { "<leader>yc",      ctx_clipboard.copy_file_path_with_cursor,                               desc = "File path with cursor" },
  ...
  { "<leader>ys",      ctx_clipboard.copy_file_with_visual_range,                              desc = "File with visual range",            mode = "v" },
}
