...
local base = {
  ...
  { "<space>nP",         function() mem_utils.add_todo_or_plan("plan", vim.g.git_master) end,    desc = "Plan (master)" },
  ...
  { "<space>nd",         function() mem_utils.add_todo_or_plan("doc") end,                       desc = "Doc (current)" },
  { "<space>nD",         function() mem_utils.add_todo_or_plan("doc", vim.g.git_master) end,     desc = "Doc (master)" },
