...
local base = {
  ...
  { "<space>nn",       function() cue_utils.add_with_path("note", vim.g.git_master) end,                     desc = "Note (" .. (vim.g.git_master or "master") .. ")" },
  { "<space>nN",       function() cue_utils.add_with_path("note") end,                                       desc = "Note (current)" },
