...
local base = {
  ...
  -- AI / Mem
  { "<C-t>",           mem_utils.pick_artifacts,                                                              desc = "[Mem] Current artifacts" },
  { "<A-t>",           function() mem_utils.pick_artifacts({ branch = vim.g.git_base }) end,                  desc = "Base branch (" .. (vim.g.git_base or "???") .. ")" },
  { "<space>e",        group = "entries" },
  { "<space>et",       function() mem_utils.pick_artifacts({ type = "todo" }) end,                            desc = "Todos (current)" },
  { "<space>eT",       function() mem_utils.pick_artifacts({ type = "todo", branch = vim.g.git_master }) end, desc = "Todos (" .. (vim.g.git_master or "master") .. ")" },
  { "<space>es",       function() mem_utils.pick_artifacts({ type = "spec" }) end,                            desc = "Specs (current)" },
  { "<space>eS",       function() mem_utils.pick_artifacts({ type = "spec", branch = vim.g.git_master }) end, desc = "Specs (" .. (vim.g.git_master or "master") .. ")" },
  { "<space>ed",       function() mem_utils.pick_artifacts({ type = "doc" }) end,                             desc = "Docs (current)" },
  { "<space>eD",       function() mem_utils.pick_artifacts({ type = "doc", branch = vim.g.git_master }) end,  desc = "Docs (" .. (vim.g.git_master or "master") .. ")" },
  { "<space>ep",       function() mem_utils.pick_artifacts({ type = "plan" }) end,                            desc = "Plans (current)" },
  { "<space>eP",       function() mem_utils.pick_artifacts({ type = "plan", branch = vim.g.git_master }) end, desc = "Plans (" .. (vim.g.git_master or "master") .. ")" },
  { "<space>ea",       group = "all branches" },
  { "<space>eat",      function() mem_utils.pick_artifacts({ type = "todo", all = true }) end,                desc = "Todos" },
  { "<space>eas",      function() mem_utils.pick_artifacts({ type = "spec", all = true }) end,                desc = "Specs" },
  { "<space>ead",      function() mem_utils.pick_artifacts({ type = "doc", all = true }) end,                 desc = "Docs" },
  { "<space>eap",      function() mem_utils.pick_artifacts({ type = "plan", all = true }) end,                desc = "Plans" },
  ...
  { "<space>nT",       function() mem_utils.add_with_title("todo", vim.g.git_master) end,                     desc = "Todo (" .. (vim.g.git_master or "master") .. ")" },
  { "<space>np",       function() mem_utils.add_with_title("plan") end,                                       desc = "Plan (current)" },
  { "<space>nP",       function() mem_utils.add_with_title("plan", vim.g.git_master) end,                     desc = "Plan (" .. (vim.g.git_master or "master") .. ")" },
  { "<space>ns",       function() mem_utils.add_spec() end,                                                   desc = "Spec (current)" },
  { "<space>nS",       function() mem_utils.add_spec(vim.g.git_master) end,                                   desc = "Spec (" .. (vim.g.git_master or "master") .. ")" },
  { "<space>nd",       function() mem_utils.add_with_title("doc") end,                                        desc = "Doc (current)" },
  { "<space>nD",       function() mem_utils.add_with_title("doc", vim.g.git_master) end,                      desc = "Doc (" .. (vim.g.git_master or "master") .. ")" },
  ...
  { "<A-l>",           mem_utils.open_log,                                                                    desc = "Open log" },
  ...
  { "<BS>m",           function() git_utils.set_base_branch(vim.g.git_master) end,                            desc = "Change base: master (" .. (vim.g.git_master or "master") .. ")" },
  ...
  { "<leader>ygb",     function() gh_utils.copy_file_url({ branch = vim.g.git_base }) end,                    desc = "GH file: base (" .. (vim.g.git_base or "???") .. ")" },
