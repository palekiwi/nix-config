...
{
  options.modules.sxhkd.flatpak_chrome = lib.mkOption {
    type = lib.types.bool;
    default = false;
  };
  ...
  config = {
    ...
    services.sxhkd = {
      ...
      keybindings = {
        ...
        "super + 0" = if config.modules.sxhkd.flatpak_chrome then "flatpak run com.google.Chrome" else "google-chrome-stable";
