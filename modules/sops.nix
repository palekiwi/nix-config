...

{
  ...
  sops.secrets."github/palekiwi/gh_cli_readonly" = { owner = "pl"; };
  ...
  sops.secrets."spabreaks/airbrake_auth_token" = { owner = "pl"; };
  sops.secrets."spabreaks/anthropic/dev-02-01" = { owner = "pl"; };
